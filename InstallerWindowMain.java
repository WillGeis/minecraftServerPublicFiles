...
public class InstallerWindowMain {
    ...
    public static void main(String[] args) {
        ...
        ///////// UNUSED//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // I dont think this needs a menu bar but Geeks for Geeks sets one up so I didnt want to get rid of it
        ...
        // Add a mouse listener to handle the link click inside the label
        label.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                // Detect if the click is on the "Fabric loader" text
                try {
        ...
        //frame.setJMenuBar(menuBar); // unused, maybe useful in a future project
    ...
    public static void copyModsToMinecraftFolder(String destinationPath) {
        File sourceDir = new File("MODS"); // Relative to the project directory
        File destDir = new File(destinationPath);

        if (!sourceDir.exists() || !sourceDir.isDirectory()) {
            System.out.println("Source 'MODS' folder not found.");
            return;
        }
        ...
        if (files == null || files.length == 0) {
            System.out.println("No files found in 'MODS' folder.");
            return;
        }
